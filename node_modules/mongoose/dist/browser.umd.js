 ...
 */
m.prototype.castForQueryWrapper=function(t){return this.$$context=t.context,"$conditional"in t?this.castForQuery(t.$conditional,t.val):t.$skipQueryCastForUpdate?this._castForQuery(t.val):this.castForQuery(t.val)},m.prototype.castForQuery=function(t,e){var r=void 0;if(2===arguments.length){if(!(r=this.$conditionalHandlers[t]))throw new Error("Can't use "+t);return r.call(this,e)}return e=t,this._castForQuery(e)},
/*!
 ...
 * Module dependencies.
 */
var i="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t};function o(t,e,r){return e in t?Object.defineProperty(t,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[e]=r,t}var s=r(17).EventEmitter,a=r(124),u=r(20),c=r(7),l=r(9),f=r(49),h=r(71),p=r(125),d=r(127),y=r(0).arrayParentSymbol,_=r(5),v=r(128),m=r(72),g=r(129),b=r(42),w=r(16).get().ReadPreference,O=r(47),S=r(3),E=r(1),A=r(130),$=void 0,j=r(131).middlewareFunctions,x=r(73).middlewareFunctions,N=j.concat(x).reduce(function(t,e){return t.add(e)},new Set),k=0;function T(t,e){if(!(this instanceof T))return new T(t,e);if(this.obj=t,this.paths={},this.aliases={},this.subpaths={},this.virtuals={},this.singleNestedPaths={},this.nested={},this.inherits={},this.callQueue=[],this._indexes=[],this.methods={},this.methodOptions={},this.statics={},this.tree={},this.query={},this.childSchemas=[],this.plugins=[],this.$id=++k,this.s={hooks:new a},this.options=this.defaultOptions(e),Array.isArray(t)){var r=!0,n=!1,i=void 0;try{for(var o,s=t[Symbol.iterator]();!(r=(o=s.next()).done);r=!0){var u=o.value;this.add(u)}}catch(t){n=!0,i=t}finally{try{!r&&s.return&&s.return()}finally{if(n)throw i}}}else t&&this.add(t);var c=t&&t._id&&E.isObject(t._id);!this.paths._id&&!this.options.noId&&this.options._id&&!c&&h(this),this.setupTimestamp(this.options.timestamps)}
/*!
...
/*!
 * Module dependencies.
 */var n=r(6),i=r(159),o=!1;t.exports=function(){return o?i:n},
/*!
 * ignore
 */
 ...
 * ignore
 */
var n=r(18),i=r(101),o={_promise:null,get:function(){return o._promise},set:function(t){n.ok("function"==typeof t,"mongoose.Promise must be a function, got "+t),o._promise=t,i.Promise=t}};
/*!
 ...
 * Module requirements.
 */
var n=r(4),i=r(134),o=r(7),s=r(135),a=r(76),u=r(1),c=r(0).populateModelSymbol,l=o.CastError,f=void 0;function h(t,e){o.call(this,t,e,"Number")}
/*!
 * ignore
 */
 ...
 * Module dependencies.
 */
var n=r(7),i=r(4),o=r(133),s=r(74),a=r(1),u=r(0).populateModelSymbol,c=n.CastError,l=void 0;function f(t,e){this.enumValues=[],this.regExp=null,n.call(this,t,e,"String")}
/*!
 * ignore
 */
...
/*!
 * Module dependencies.
 */var n=r(51),i=r(12),o=r(17).EventEmitter,s=r(141),a=r(7),u=r(78),c=r(5),l=r(3),f=r(1),h=r(79),p=r(0).arrayParentSymbol,d=r(0).arrayPathSymbol,y=void 0,_=void 0;function v(t,e,r,i){var o=m(e,r);o.prototype.$basePath=t,n.call(this,t,o,r),this.schema=e,this.schemaOptions=i||{},this.$isMongooseDocumentArray=!0,this.Constructor=o,o.base=e.base;var s=this.defaultValue;"defaultValue"in this&&void 0===s||this.default(function(){var t=s.call(this);return Array.isArray(t)||(t=[t]),t});var u=this;this.$embeddedSchemaType=new a(t+".$",{required:c(this,"schemaOptions.required",!1)}),this.$embeddedSchemaType.cast=function(t,e,r){return u.cast(t,e,r)[0]},this.$embeddedSchemaType.$isMongooseDocumentArrayElement=!0,this.$embeddedSchemaType.caster=this.Constructor,this.$embeddedSchemaType.schema=this.schema}
/*!
 * Ignore
 */
function m(t,e,n){function i(){_.apply(this,arguments),this.$session(this.ownerDocument().$session())}_||(_=r(24));var s=null!=n?n.prototype:_.prototype;for(var a in i.prototype=Object.create(s),i.prototype.$__setSchema(t),i.schema=t,i.prototype.constructor=i,i.$isArraySubdocument=!0,i.events=new o,t.methods)i.prototype[a]=t.methods[a];for(var u in t.statics)i[u]=t.statics[u];for(var c in o.prototype)i[c]=o.prototype[c];return i.options=e,i}
/*!
 ...
 */
function g(t,e,r){if(r&&e){for(var n=t.path+".",i=Object.keys(e),o=i.length,s={},a=void 0,u=void 0,c=void 0;o--;)if((u=i[o]).startsWith(n)){if("$"===(c=u.substring(n.length)))continue;c.startsWith("$.")&&(c=c.substr(2)),a||(a=!0),s[c]=e[u]}return a&&s||void 0}}
/*!
 * Module exports.
 */v.schemaName="DocumentArray",v.options={castNonArrays:!0},
/*!
 * Inherits from ArrayType.
 */
v.prototype=Object.create(n.prototype),v.prototype.constructor=v,v.prototype.OptionsConstructor=s,v.prototype.discriminator=function(t,e,r){"function"==typeof t&&(t=f.getFunctionName(t));var n=m(e=u(this.casterConstructor,t,e,r),null,this.casterConstructor);n.baseCasterConstructor=this.casterConstructor;try{Object.defineProperty(n,"name",{value:t})}catch(t){}return this.casterConstructor.discriminators[t]=n,this.casterConstructor.discriminators[t]},v.prototype.doValidate=function(t,e,n,i){y||(y=r(15));var o=this;try{a.prototype.doValidate.call(this,t,function(r){if(r)return r.$isArrayValidatorError=!0,e(r);var s=t&&t.length,a=void 0;if(!s)return e();if(i&&i.updateValidator)return e();t.isMongooseDocumentArray||(t=new y(t,o.path,n));function u(t){null!=t&&"ValidationError"!==(a=t).name&&(a.$isArrayValidatorError=!0),--s||e(a)}for(var c=0,l=s;c<l;++c){var f=t[c];if(null!=f){if(!(f instanceof _)){var p=h(o.casterConstructor,t[c]);f=t[c]=new p(f,t,void 0,void 0,c)}f.$__validate(u)}else--s||e(a)}},n)}catch(t){return t.$isArrayValidatorError=!0,e(t)}},v.prototype.doValidateSync=function(t,e){var r=a.prototype.doValidateSync.call(this,t,e);if(null!=r)return r.$isArrayValidatorError=!0,r;var n=t&&t.length,i=null;if(n){for(var o=0,s=n;o<s;++o){var u=t[o];if(u){if(!(u instanceof _)){var c=h(this.casterConstructor,t[o]);u=t[o]=new c(u,t,void 0,void 0,o)}var l=u.validateSync();l&&null==i&&(i=l)}}return i}},
/*!
 * ignore
 */
v.prototype.getDefault=function(t){var e="function"==typeof this.defaultValue?this.defaultValue.call(t):this.defaultValue;if(null==e)return e;y||(y=r(15)),Array.isArray(e)||(e=[e]);var n=(e=new y(e,this.path,t))[p];e[p]=null;for(var i=0;i<e.length;++i){var o=h(this.casterConstructor,e[i]);e[i]=new o(e[i],e,void 0,void 0,i)}return e[p]=n,e},v.prototype.cast=function(t,e,n,o,s){y||(y=r(15));var a=void 0,u=void 0,c=void 0,p={transform:!1,virtuals:!1};if(!Array.isArray(t)){if(!n&&!v.options.castNonArrays)throw new i("DocumentArray",l.inspect(t),this.path,null,this);return e&&n&&e.markModified(this.path),this.cast([t],e,n,o)}for(t&&t.isMongooseDocumentArray||s&&s.skipDocumentArrayCast?t&&t.isMongooseDocumentArray&&(t=new y(t,this.path,e)):t=new y(t,this.path,e),c=t.length;c--;)if(t[c]){var m=h(this.casterConstructor,t[c]);if(!t[c].$__||t[c]instanceof m||(t[c]=t[c].toObject({transform:!1,virtuals:t[c].schema===m.schema})),t[c]instanceof _)null==t[c].__index&&t[c].$setIndex(c);else if(null!=t[c])if(n)e?a||(a=g(this,e.$__.selected,n)):a=!0,u=new m(null,t,!0,a,c),t[c]=u.init(t[c]);else if(o&&"function"==typeof o.id&&(u=o.id(t[c]._id)),o&&u&&f.deepEqual(u.toObject(p),t[c]))u.set(t[c]),t[c]=u;else try{u=new m(t[c],t,void 0,void 0,c),t[c]=u}catch(e){var b=l.inspect(t[c]);throw new i("embedded",b,t[d],e,this)}}return t},
/*!
 * ignore
 */
v.prototype.clone=function(){var t=Object.assign({},this.options),e=new this.constructor(this.path,this.schema,t,this.schemaOptions);return e.validators=this.validators.slice(),e.Constructor.discriminators=Object.assign({},this.Constructor.discriminators),e},t.exports=v},function(t,e,r){"use strict";var n=r(9),i=function(t){function e(){return function(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,e),function(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}(this,(e.__proto__||Object.getPrototypeOf(e)).apply(this,arguments))}return function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}(e,n),e}(),o=r(11);Object.defineProperty(i.prototype,"enum",o),
/*!
 * ignore
 */
t.exports=i},function(t,e,r){"use strict";
...
/*!
 * Module dependencies.
 */var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},i=r(12),o=r(17).EventEmitter,s=r(70),a=r(143),u=r(7),c=r(45),l=r(71),f=r(29).castToNumber,h=r(78),p=r(77),d=r(5),y=r(79),_=r(19).internalToObjectOptions,v=void 0;function m(t,e,r){null!=r&&null!=r._id&&(t=t.clone(),r._id?t.paths._id||(l(t),t.options._id=!0):(t.remove("_id"),t.options._id=!1)),this.caster=g(t),this.caster.path=e,this.caster.prototype.$basePath=e,this.schema=t,this.$isSingleNested=!0,u.call(this,e,r,"Embedded")}
/*!
 * ignore
 */
/*!
 ...
 * ignore
 */
m.prototype.$conditionalHandlers.$near=m.prototype.$conditionalHandlers.$nearSphere=p.cast$near,m.prototype.$conditionalHandlers.$within=m.prototype.$conditionalHandlers.$geoWithin=p.cast$within,m.prototype.$conditionalHandlers.$geoIntersects=p.cast$geoIntersects,m.prototype.$conditionalHandlers.$minDistance=f,m.prototype.$conditionalHandlers.$maxDistance=f,m.prototype.$conditionalHandlers.$exists=c,m.prototype.cast=function(t,e,r,i){if(t&&t.$isSingleNested&&t.parent===e)return t;if(null!=t&&("object"!==(void 0===t?"undefined":n(t))||Array.isArray(t)))throw new s(this.path,t);var o=y(this.caster,t),a=void 0,u=d(e,"$__.selected",{}),c=this.path,l=Object.keys(u).reduce(function(t,e){return e.startsWith(c+".")&&(t[e.substr(c.length+1)]=u[e]),t},{});return r?((a=new o(void 0,l,e)).init(t),a):0===Object.keys(t).length?new o({},l,e):new o(t,l,e,void 0,{priorDoc:i})},m.prototype.castForQuery=function(t,e){var r=void 0;if(2===arguments.length){if(!(r=this.$conditionalHandlers[t]))throw new Error("Can't use "+t);return r.call(this,e)}if(null==(e=t))return e;this.options.runSetters&&(e=this._applySetters(e));var n=y(this.caster,e);try{e=new n(e)}catch(t){if(!(t instanceof i))throw new i("Embedded",e,this.path,t,this);throw t}return e},m.prototype.doValidate=function(t,e,r,n){var i=y(this.caster,t);if(n&&n.skipSchemaValidators)return t instanceof i||(t=new i(t,null,r)),t.validate(e);u.prototype.doValidate.call(this,t,function(r){return r?e(r):t?void t.validate(e):e(null)},r)},m.prototype.doValidateSync=function(t,e,r){if(!r||!r.skipSchemaValidators){var n=u.prototype.doValidateSync.call(this,t,e);if(n)return n}if(t)return t.validateSync()},m.prototype.discriminator=function(t,e,r){return h(this.caster,t,e,r),this.caster.discriminators[t]=g(e,this.caster),this.caster.discriminators[t]},
/*!
 * ignore
 */
 ...
 * Module dependencies.
 */
var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},i=r(65),o=r(145),s=r(7),a=r(76),u=r(1),c=r(0).populateModelSymbol,l=i.Binary,f=s.CastError,h=void 0;function p(t,e){s.call(this,t,e,"Buffer")}
/*!
 * ignore
 */
...
/*!
 * Module requirements.
 */var n=r(4),i=r(147),o=r(7),s=r(148),a=r(1),u=o.CastError;function c(t,e){o.call(this,t,e,"Date")}
/*!
 * Date Query casting.
 *
 * @api private
 ...
 * Module dependencies.
 */
var n=r(7),i=n.CastError,o=r(22),s=r(152),a=r(1),u=r(0).populateModelSymbol,c=void 0;function l(t,e){n.call(this,t,e,"Decimal128")}
/*!
 * ignore
 */
 ...
 */
function n(){return null!=this._id?String(this._id):null}t.exports=function(t){!t.paths.id&&!t.options.noVirtualId&&t.options.id&&t.virtual("id").get(n)}},function(t,e,r){"use strict";var n=r(80);
/*!
 * ignore
